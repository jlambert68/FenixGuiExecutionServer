...
func (fenixGuiExecutionServerObject *fenixGuiExecutionServerObjectStruct) InitGrpcServer() {
...
func (fenixGuiExecutionServerObject *fenixGuiExecutionServerObjectStruct) StopGrpcServer() {

	fenixGuiExecutionServerObject.logger.WithFields(logrus.Fields{}).Info("Gracefully stop for: registerFenixGuiExecutionServerGrpcServicesServer")
