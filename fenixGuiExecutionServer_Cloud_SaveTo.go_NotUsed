...
func (fenixGuiTestCaseBuilderServerObject *fenixGuiExecutionServerObjectStruct) prepareSavePinnedTestInstructionsAndPinnedTestInstructionContainersToCloudDB(pinnedTestInstructionsAndTestContainersMessage *fenixTestCaseBuilderServerGrpcApi.SavePinnedTestInstructionsAndPreCreatedTestInstructionContainersMessage) (returnMessage *fenixTestCaseBuilderServerGrpcApi.AckNackResponse) {
	...
	if err != nil {
		...
		// fenixGuiExecutionServerObject.stateProcessIncomingAndOutgoingMessage = true
		/*
...
func (fenixGuiTestCaseBuilderServerObject *fenixGuiExecutionServerObjectStruct) savePinnedTestInstructionsAndTestContainersToCloudDB(dbTransaction pgx.Tx, pinnedTestInstructionsAndTestContainersMessage *fenixTestCaseBuilderServerGrpcApi.SavePinnedTestInstructionsAndPreCreatedTestInstructionContainersMessage) (err error) {
