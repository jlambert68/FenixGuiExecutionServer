...
func startTesterGuiOwnerEngineChannelReader() {
	...
	for {
		...
		case common_config.ChannelCommand_AnotherGuiExecutionServersUserUnsubscribesToUserAndTestCaseExecutionCombination:
			processAnotherGuiExecutionServersUserUnsubscribesToUserAndTestCaseExecutionCombination(
				incomingTesterGuiOwnerEngineChannelCommand)

		case common_config.ChannelCommand_AnotherGuiExecutionServersUserSubscribesToUserAndTestCaseExecutionCombination:
			processAnotherGuiExecutionServersUserSubscribesToUserAndTestCaseExecutionCombination(
				incomingTesterGuiOwnerEngineChannelCommand)

		case common_config.ChannelCommand_ThisGuiExecutionServersTesterGuiIsStartingUp:
			processThisGuiExecutionServersTesterGuiIsStartingUp(incomingTesterGuiOwnerEngineChannelCommand)

		case common_config.ChannelCommand_AnotherGuiExecutionServersTesterGuiIsStartingUp:
			processAnotherGuiExecutionServersTesterGuiIsStartingUp(incomingTesterGuiOwnerEngineChannelCommand)
...
func processAnotherGuiExecutionServersUserSubscribesToUserAndTestCaseExecutionCombination(
	incomingTesterGuiOwnerEngineChannelCommand *common_config.TesterGuiOwnerEngineChannelCommandStruct) {
...
// Process channel command 'ChannelCommand_ThisGuiExecutionServersTesterGuiIsStartingUp'
func processThisGuiExecutionServersTesterGuiIsStartingUp(
	incomingTesterGuiOwnerEngineChannelCommand *common_config.TesterGuiOwnerEngineChannelCommandStruct) {

	// Process the actual command 'ChannelCommand_ThisGuiExecutionServersTesterGuiIsStartingUp'
	commandThisGuiExecutionServersTesterGuiIsStartingUp(
		incomingTesterGuiOwnerEngineChannelCommand.TesterGuiIsStartingUp)
}

// Process channel command 'ChannelCommand_AnotherGuiExecutionServersTesterGuiIsStartingUp'
func processAnotherGuiExecutionServersTesterGuiIsStartingUp(
	incomingTesterGuiOwnerEngineChannelCommand *common_config.TesterGuiOwnerEngineChannelCommandStruct) {

	// Process the actual command 'ChannelCommand_AnotherGuiExecutionServersTesterGuiIsStartingUp'
	commandAnotherGuiExecutionServersTesterGuiIsStartingUp(
		incomingTesterGuiOwnerEngineChannelCommand.TesterGuiIsStartingUp)
}
