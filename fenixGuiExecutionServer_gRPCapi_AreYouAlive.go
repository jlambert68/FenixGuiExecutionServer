...
func (s *fenixGuiExecutionServerGrpcServicesServer) AreYouAlive(ctx context.Context, emptyParameter *fenixExecutionServerGuiGrpcApi.EmptyParameter) (*fenixExecutionServerGuiGrpcApi.AckNackResponse, error) {
